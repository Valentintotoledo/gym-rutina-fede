...
export const ROUTINE: Day[] = [
  {
    ...
    ejercicios: [
      ...
      { id: 'lun-elevacion-lateral', nombre: 'Elevación lateral (mancuernas)', grupo: 'HOMBRO', biserie: 'hombro', series: 3, reps: 9, repsLabel: '8-10', pesoBase: 15, nota: 'Bi-serie con press hombro. RIR 0-1, sin balanceo.' },
